...
MATRIX: dict[str, list[str]] = {
    ...
    "T44": [
        ...
        DELEG + "test_r01h1_a_cycle_during_admission_runs_nothing_uncommitted",
        DELEG + "test_r01h2_a_replay_during_a_cycle_leaves_no_trace",
        DELEG + "test_r01h3_a_failed_admission_during_a_cycle_leaks_nothing",
        DELEG + "test_r01h4_cancelling_admission_resolves_what_was_committed",
        DELEG + "test_r01h_an_acceptance_whose_goal_was_lost_is_recovered_once",
        DELEG + "test_r01i1_a_lost_goal_after_a_write_resumes_without_a_second_write",
        DELEG + "test_r01i2_recovery_keeps_the_charged_model_call",
        DELEG + "test_r01i3_a_finished_child_with_a_lost_settlement_replays_its_result",
        DELEG + "test_r01i4_an_unresolved_effect_gets_no_fresh_execution",
